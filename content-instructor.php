...
$bio_excert                  = get_field('bio_excert');
$full_bio                    = get_field('full_bio');
$twitter_username            = get_field('twitter_username');
$facebook_username            = get_field('facebook_username');
$google_plus_username         = get_field('google_plus_username');
$num_students                 = get_field('numbers_of_students');
$num_reviews                 = get_field('numbers_of_reviews');
$num_courses                = get_field('numbers_of_courses');
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 col-md-6">
				...
				<p class="lead"><?php echo $bio_excert ?><p>
